...
<div id="divmenu">
		...
		<a href="${pageContext.request.contextPath}/showProductByPage?category=亚瑟士">亚瑟士</a> 
		<a href="${pageContext.request.contextPath}/showProductByPage?category=新百伦">新百伦</a> 
		<a href="${pageContext.request.contextPath}/showProductByPage?category=彪马">彪马</a>
		...
		<a href="${pageContext.request.contextPath}/showProductByPage?category=回力">回力</a> 
	...
	<table width="100%" border="0" cellspacing="0">
		<tr>
			<td style="text-align:right; padding-right:220px">
				Search 
				<input type="text" name="textfield" class="inputtable" id="textfield" value="请输入品牌"
